...
"Project_4.ipynb" contains all the information regarding the code implementation in the form of markdowns and comments. The document "Project 4 Report" also discusses the code implementation as well as the analysis of results.
